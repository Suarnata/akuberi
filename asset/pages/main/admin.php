...
<?php
  ...
  $query = mysqli_query($process->connection,"SELECT * FROM user_table");
  $jmlpengguna = mysqli_num_rows($query);
  $query = mysqli_query($process->connection,"SELECT * FROM post_table");
  $jmldonasi = mysqli_num_rows($query);
?>
            ...
            <div class="col-9 col-s-12 content-post-a2">
              <div class="col-12 news">
                <div class="col-4plus col-s-11 news1 bg-news-1 bg-color3">
                  ...
                  <h3 style="font-size: 20px;color: #fff;text-align: center;transform: translate(0,20%);">Total Pengguna</h3>
                  <h5 style="font-size:25px;text-align:center;color: #fff;transform: translate(0,-20%);"><?php echo $jmlpengguna; ?> Orang</h5>
                </div>
                <div class="col-4plus col-s-11 news1 bg-news-2 bg-color3">
                  ...
                  <h3 style="font-size: 20px;color: #00aeea;text-align: center;transform: translate(0,20%);">Jumlah Donasi</h3>
                   <h5 style="font-size:25px;text-align:center;color: #00aeea;transform: translate(0,-20%);"><?php echo $jmldonasi; ?> Postingan</h5>
                </div>
              </div>
