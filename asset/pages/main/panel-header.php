        ...
        <div class="col-2 col-s-12 sidebar-a bg-color1">
          ...
          <div class="col-12 col-s-12 sidebar-b">
            <ul>
              ...
              <li id="menu-pengguna"> <a href="pengguna.php"> <i class="fas fa-users"></i> &nbsp;&nbsp;List Pengguna </a> </li>
              <li id="menu-list-donasi"> <a href="lis-donasi.php"> <i class="fas fa-ambulance"></i> &nbsp;&nbsp; List-donasi </a> </li>
             <!--  <li id="menu-kategori"> <a href="category.php"> <i class="fas fa-tags"></i> &nbsp;&nbsp;&nbsp;&nbsp; Kategori </a> </li> -->
              <li id="menu-pengumuman"> <a href="pengumuman.php"> <i class="fas fa-clipboard-list"></i> &nbsp;&nbsp;&nbsp;&nbsp; Pengumuman </a> </li>
               <li id="menu-pengumuman"> <a href="user.php"> <i class="fas fa-user"></i> &nbsp;&nbsp;&nbsp;&nbsp;Menu Pengguna </a> </li>
              <li id="menu-pengaturan"> <a href="pengaturan-user.php"> <i class="fas fa-cogs"></i> &nbsp;&nbsp; Pengaturan </a> </li>
            </ul>
          </div>
        </div>  <!-- Sidebar -->
